...
public:
	...
	static nrfx_err_t nrfx_saadc_init(nrfx_saadc_config_t const *p_config, nrfx_saadc_event_handler_t event_handler) {
		(void)p_config;
		(void)event_handler;
		return NRFX_SUCCESS;
	}

	static nrfx_err_t nrfx_saadc_calibrate_offset() { return NRFX_SUCCESS; }

	static bool nrfx_saadc_is_busy() { return false; }

	static void nrfx_saadc_uninit() { m_is_started = false; }
