...
enum nrf_gpiote_polarity_t { NRF_GPIOTE_POLARITY_LOTOHI, NRF_GPIOTE_POLARITY_HITOLO, NRF_GPIOTE_POLARITY_TOGGLE };
...
public:
	...
	static void nrfx_gpiote_in_event_disable(nrfx_gpiote_pin_t pin) { (void)pin; }

	static nrfx_err_t nrfx_gpiote_in_init(nrfx_gpiote_pin_t pin, nrfx_gpiote_in_config_t const *p_config,
	...
	static void nrfx_gpiote_in_uninit(nrfx_gpiote_pin_t pin) { (void)pin; }

	static void trigger(nrfx_gpiote_pin_t pin, nrf_gpiote_polarity_t action) { m_map[pin](pin, action); }

	static bool nrfx_gpiote_is_init() { return m_is_init; }

	static void nrfx_gpiote_uninit() { m_is_init = false; }
