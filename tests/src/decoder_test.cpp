...
TEST(Decoder, ArgosDepthPile) {
	...
	CHECK_TRUE(DTEDecoder::decode(s, command, error_code, arg_list, params, param_values));
	CHECK_TRUE(DTECommand::PARMR_RESP == command);
	CHECK_TRUE(BaseDepthPile::DEPTH_PILE_1 == std::get<BaseDepthPile>(param_values[0].value));
	param_values.clear();
	s = "$O;PARMR#007;ARP16=2\r";
	CHECK_TRUE(DTEDecoder::decode(s, command, error_code, arg_list, params, param_values));
	CHECK_TRUE(DTECommand::PARMR_RESP == command);
	CHECK_TRUE(BaseDepthPile::DEPTH_PILE_2 == std::get<BaseDepthPile>(param_values[0].value));
	param_values.clear();
	s = "$O;PARMR#007;ARP16=3\r";
	CHECK_TRUE(DTEDecoder::decode(s, command, error_code, arg_list, params, param_values));
	CHECK_TRUE(DTECommand::PARMR_RESP == command);
	CHECK_TRUE(BaseDepthPile::DEPTH_PILE_3 == std::get<BaseDepthPile>(param_values[0].value));
	param_values.clear();
	s = "$O;PARMR#007;ARP16=4\r";
	CHECK_TRUE(DTEDecoder::decode(s, command, error_code, arg_list, params, param_values));
	CHECK_TRUE(DTECommand::PARMR_RESP == command);
	CHECK_TRUE(BaseDepthPile::DEPTH_PILE_4 == std::get<BaseDepthPile>(param_values[0].value));
	param_values.clear();
	s = "$O;PARMR#007;ARP16=8\r";
	CHECK_TRUE(DTEDecoder::decode(s, command, error_code, arg_list, params, param_values));
	CHECK_TRUE(DTECommand::PARMR_RESP == command);
	CHECK_TRUE(BaseDepthPile::DEPTH_PILE_8 == std::get<BaseDepthPile>(param_values[0].value));
	param_values.clear();
	s = "$O;PARMR#007;ARP16=9\r";
	CHECK_TRUE(DTEDecoder::decode(s, command, error_code, arg_list, params, param_values));
	CHECK_TRUE(DTECommand::PARMR_RESP == command);
	CHECK_TRUE(BaseDepthPile::DEPTH_PILE_12 == std::get<BaseDepthPile>(param_values[0].value));
	param_values.clear();
	s = "$O;PARMR#008;ARP16=10\r";
	CHECK_TRUE(DTEDecoder::decode(s, command, error_code, arg_list, params, param_values));
	CHECK_TRUE(DTECommand::PARMR_RESP == command);
	CHECK_TRUE(BaseDepthPile::DEPTH_PILE_16 == std::get<BaseDepthPile>(param_values[0].value));
	param_values.clear();
	s = "$O;PARMR#008;ARP16=11\r";
	CHECK_TRUE(DTEDecoder::decode(s, command, error_code, arg_list, params, param_values));
	CHECK_TRUE(DTECommand::PARMR_RESP == command);
	CHECK_TRUE(BaseDepthPile::DEPTH_PILE_20 == std::get<BaseDepthPile>(param_values[0].value));
	param_values.clear();
