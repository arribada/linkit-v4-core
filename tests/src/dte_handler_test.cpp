...
TEST(DTEHandler, STATR_REQ_CheckEmptyRequest)
{
	...
	CHECK_TRUE(DTEAction::NONE == dte_handler->handle_dte_message(req, resp));
	STRCMP_EQUAL("$O;STATR#0C6;IDT06=0,IDT02=LinkIt V4,IDT03=V0.1,ART01=01/01/1970 00:00:00,ART02=0,POT03=0,ART03=07/10/2021 22:41:14,ART10=0,ART11=0,IDT04=simulator,POT06=0,IDT10=305419896,SYT01=0,PPT01=0,PPT02=0,PPT03=0,PPT04=0\r", resp.c_str());
}
