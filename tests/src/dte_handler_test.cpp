...
TEST(DTEHandler, PARMR_REQ) {
	...
	STRCMP_EQUAL(
	    ...
	    "22:41:14,ARP05=60,ARP01=2,ARP19=0,ARP18=0,GNP01=1,ARP11=1,ARP16=10,GNP02=1,GNP03=5,GNP05=120,UNP01=0,UNP02=0,"
	    "UNP03=1,LBP01=0,LBP02=10,ARP06=240,LBP04=2,LBP05=0,LBP06=1,ARP12=4,LBP07=5,LBP08=1,LBP09=120\r",
	    resp.c_str());
}
...
TEST(DTEHandler, PARMR_REQ_CheckEmptyRequest) {
	...
	CHECK_TRUE(DTEAction::NONE == dte_handler->handle_dte_message(req, resp));
	// 2026-08: SMP00 (SMD_DEGRADED_MODE) left this list too — it is declared
	// (ARGOS_SMD == 1) now. Nothing outside the SMD driver reads it, and the
	// SAFE timings it selects are SMD SPI timings.
	//
	...
	// #803 -> #836 (2026-09): +CAP01..CAP05/LBP13 after THP08. The host build
	// now compiles the camera (ENABLE_CAM_SENSOR=1) like every other sensor,
	// so cam_service.cpp is under test and its keys are advertised here.
	STRCMP_EQUAL(
	    "$O;PARMR#836;IDP12=0,IDP11=FACTORY,ARP05=60,ARP01=2,ARP19=0,ARP18=0,GNP01=1,ARP11=1,ARP16=10,GNP02=1,GNP03=5,"
	    "GNP05=120,GNP04=0,UNP01=0,UNP02=0,UNP03=1,LBP01=0,LBP02=10,ARP06=240,LBP04=2,LBP05=0,LBP06=1,ARP12=4,LBP07=5,"
	    "LBP08=1,LBP09=120,UNP04=10,PPP01=15,PPP02=90,PPP03=30,PPP04=1000,PPP05=300,PPP06=10,GNP09=530,GNP10=3,GNP11=0,"
	    "GNP20=1,GNP21=50,GNP22=1,GNP23=60,ARP30=1,LDP01=1,ARP31=1,ARP32=1,ARP33=900,ARP34=90,GNP24=1,LBP10=50,LBP11=4,"
	    "ZOP01=1,ZOP04=0,ZOP05=1,ZOP06=01/01/2020 "
	    "00:00:00,ZOP08=1,ZOP10=240,ZOP11=2,ZOP12=16777215,ZOP13=0,ZOP14=4,ZOP15=5,ZOP16=50,ZOP17=240,ZOP18=-123.392,"
	    ...
	    "PRP06=1000,AXP05=0,AXP06=1,AXP07=1000,THP06=0,THP07=1,THP08=1000,CAP01=0,CAP02=0,CAP03=0,CAP04=60,"
	    "CAP05=300,LBP13=0,IDP14=,GNP30=0,PRP07=0,GNP31="
	    ...
	    "00:00:00,SMP01=0,GNP50=86400,RLP01=0,RLP02=3600,RLP03=10,HMP00=0,HMP01=24,HMP02=3,HMP10=2,HMP11=7200,"
