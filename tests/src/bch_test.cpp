...
TEST(BCH, LongMessageReferenceSpec) {
	std::string data =
	    "\x8B\xE3\x81\xA9\x49\xC0\x39\xFE\x03\xBE\xA9\x52\x93\xB0\x73\xF4\x2A\xD2\x30\x0E\x79\x85\x5A\x46\x81\xCF\x34"s;
	BCHCodeWord code_word =
	    BCHEncoder::encode(BCHEncoder::B255_223_4, sizeof(BCHEncoder::B255_223_4), data, data.size() * 8);
