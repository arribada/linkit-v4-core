...
public:
	int mount() { return mock().actualCall("mount").onObject(this).returnIntValue(); }
	int umount() { return mock().actualCall("umount").onObject(this).returnIntValue(); }
	bool is_mounted() { return mock().actualCall("is_mounted").onObject(this).returnBoolValue(); }
	int format() { return mock().actualCall("format").onObject(this).returnIntValue(); }
	...
	void *get_private_data() { return nullptr; }
};
